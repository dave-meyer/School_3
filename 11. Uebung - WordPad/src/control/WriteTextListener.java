...
/**
 * Der in der GUI/View eingegebene Text soll auf Festplatte in Textform gespeichert werden.
 ...
 */
public class WriteTextListener implements ActionListener {

	private WordPad gui;
	
	public WriteTextListener(WordPad gui) {
		this.gui = gui;
	}
