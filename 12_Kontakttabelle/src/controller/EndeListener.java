...
public class EndeListener implements ActionListener {
	 ...
	 * ---
	 * Jetzt:
	 * Die Daten der Kontakttabelle werden von der GUI geholt und in die Datenbank gespeichert
	 */
	@Override
	public void actionPerformed(ActionEvent arg0) {
		...
		*/
		...
		// Am Ende sollen die Kontaktdaten in die Datenbank gespeichert werden
		Datenbank.writeKontakteToDatabase(gui.getTabelle());
